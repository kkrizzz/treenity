...
add(function ComponentList({ components, onChange, isEditable, onChoose, onDelete, componentsBaseId }) {
    useCSS(
        'component-list',
        css`
      .settings-button {
                ...
                {(provided, snapshot) => (
                    ...
                    >
                        {components.map((item, index) => {
                            ...
                            const Component = render(componentsBaseId, `${item.componentID}-component`, 'components');
