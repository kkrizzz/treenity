...
const txHashColumn = {
  ...
  render: (receipt) => (
    <div style={{ maxWidth: 100 }}>
      <NamedHash hash={receipt.originated_from_transaction_hash} type="new-transaction" />
    </div>
  ),
};
...
const txFromColumn = {
  ...
  render: (receipt) => (
    <div style={{ maxWidth: 200 }}>
      <NamedHash hash={receipt.predecessor_account_id} type="new-account" />
    </div>
  ),
};
...
const txToColumn = {
  ...
  render: (receipt) => (
    <div style={{ maxWidth: 200 }}>
      <NamedHash hash={receipt.receiver_account_id} type="new-account" />
    </div>
  ),
};
  ...
  tokenTransfers: [
    ...
    },
    {
      ...
      render: (receiptAction) => (
        <Hash hash={receiptAction.receipt_predecessor_account_id} type="new-account" />
      ),
    },
    {
      title: 'To',
      dataIndex: 'receipt_action',
      render: (receiptAction) => (
        <Hash hash={receiptAction.args.args_json.receiver_id} type="new-account" />
      ),
    },
    {
      title: 'Token',
