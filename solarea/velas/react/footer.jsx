    ...
    <footer className="bu-footer">
      <div className="bu-container bu-is-max-desktop" style={{ padding: '0 2rem' }}>
        <div className="bu-columns bu-is-mobile">
          <div className="bu-column bu-is-8-desktop bu-is-8-tablet bu-is-6-mobile">
            <div className="bu-columns">
              <div className="bu-column bu-is-6-desktop bu-is-6-tablet bu-is-12-mobile footer-list">
                <h4>Velas</h4>
                <ul>
                  <li>
                    <a
          ...
          <div className="bu-column bu-is-4-desktop bu-is-4-tablet bu-is-6-mobile">
            <div className="bu-columns">
              <div className="bu-column bu-is-6-desktop bu-is-6-tablet bu-is-12-mobile footer-list">
                <h4>Networks</h4>
                <ul>
