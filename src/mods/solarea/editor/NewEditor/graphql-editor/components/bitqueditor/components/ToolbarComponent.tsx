...
const ToolbarComponent = ({ queryEditor, variablesEditor, docExplorerOpen, toggleDocExplorer }) => {
  ...
  const prettifyQuery = () => {
    ...
    const prettifiedEditorContent =
      editorContent && print(parseGql(editorContent, { experimentalFragmentVariables: true }));
  ...
  return (
    <div className="topBarWrap">
      <div className="topBar">
        {!currentQuery.layout && (
          <button className="topBar__button" onClick={prettifyQuery}>
            Prettify
          </button>
        )}
        {!currentQuery.layout && (
        ...
        {!docExplorerOpen ? (
          ...
          <div className="doc-explorer-title-bar">
            <div className="doc-explorer-title">Documentation Explorer</div>
